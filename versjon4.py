...
def credits():
    while True:
        ...
        CREDITS_TEXT = get_font(45).render("By Orlando Olaf Thalberg", True, "Black")
        CREDITS_RECT = CREDITS_TEXT.get_rect(center=(SCREEN.get_width() // 2, SCREEN.get_height() // 2))
...
def main_menu():
    while True:
        ...
        MENU_TEXT = get_font(100).render("Silent Ride", True, "#b68f40")  # Changed to Silent Ride
        MENU_RECT = MENU_TEXT.get_rect(center=(SCREEN.get_width() // 2, SCREEN.get_height() // 4))  # Adjusted vertical position

        PLAY_BUTTON = Button(image=pygame.image.load("Play Rect.png"), pos=(SCREEN.get_width() // 2, SCREEN.get_height() // 2), 
                            text_input="PLAY", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        CREDITS_BUTTON = Button(image=pygame.image.load("Options Rect.png"), pos=(SCREEN.get_width() // 2, SCREEN.get_height() // 2 + 150), 
                            text_input="CREDITS", font=get_font(75), base_color="#d7fcd4", hovering_color="White")  # Changed to CREDITS
        QUIT_BUTTON = Button(image=pygame.image.load("Quit Rect.png"), pos=(SCREEN.get_width() // 2, SCREEN.get_height() // 2 + 300), 
